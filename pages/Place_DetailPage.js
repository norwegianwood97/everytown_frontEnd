  ...
  const handleSubmitReview = async () => {
    try {
      const response = await axios.post(
          `http://localhost:8080/place/${id}/review`,
          newReview,
      );
  ...
  return (
    <div>
      ...
      <div className="place-info">
        ...
        <div>
          <div className="place-category">
            ...
            <p><div className='place-item-tag'>{renderTag(PlaceData.tag)}</div></p>
      ...
      <div className="place-reviews-and-image">
        {/* 리뷰 작성 섹션 */}
        <div className="place-review-write-and-image">
          <div className="place-review-write">
            <div><b>매장 리뷰</b></div>
            <p></p>
            <textarea
            ...
            <div className="review-bottom-section">
              ...
              &nbsp;
              <button className="submit-review-button" onClick={handleSubmitReview}>등록
              </button>
            </div>
          </div>
